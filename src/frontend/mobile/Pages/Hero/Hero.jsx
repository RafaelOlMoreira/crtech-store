...
function Hero() {
    return (
        // Div geral Hero
        <div className='overflow-x-hidden pt-32 h-auto bg-center bg-cover bg-no-repeat flex items-center' style={{ backgroundImage: `url(${HeroImage})` }}>
            {/* Div dos componentes do Hero */}
            <div className='p-5 py-10 pr-20 space-y-5'>
                ...
                <h3 className='text-white text-[30px] font-bebasneue font-extrabold drop-shadow-xs uppercase'><p>Capinhas,</p> <p>Películas,</p> <p>Fones sem fio,</p> <p>Carregadores Rápidos</p></h3>
