        ...
        <div className='h-auto overflow-y-hidden py-10 px-4 font-montserrat' id='Novidade'>
            ...
            <div className='pt-10 space-y-5 mx-auto'>
                ...
                <div className='flex justify-center'>
                    <a href='https://www.instagram.com/cr.tech_bh/' class="flex p-3 px-10 rounded-md gap-x-2 text-white bg-linear-to-r from-purple-500 to-pink-500 hover:bg-linear-to-l focus:ring-2 focus:outline-none focus:ring-purple-200 dark:focus:ring-purple-800">
