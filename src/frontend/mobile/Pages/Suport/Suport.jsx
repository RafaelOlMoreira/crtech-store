            ...
            <div className='pb-10 space-y-3'>
                ...
                <div className='space-y-3'>
                    <form action="#" className='space-y-3'>
                        ...
                        <textarea name="mensagem" id="mensagem" rows={4} placeholder='Descreva seu problema ou dúvida...' className='w-full border-2 border-[#00b7ff7e] hover:border-[#00b7ff] focus:border-[#00b7ff] outline-0 p-2 rounded-lg'>
                    ...
                    <button type="submit" className='w-full bg-[#00b7ff7e] hover:bg-[#00b7ff] p-2 rounded-lg text-white'>Enviar Mensagem</button>
                    <div className='flex'>
