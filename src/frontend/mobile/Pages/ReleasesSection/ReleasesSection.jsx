...
function Releases() {
    return (
        <section id='lançamentos' className='scroll-mt-32 py-10 px-8 md:px-32'>
            <div className=' text-center space-y-1.5'>
                <h1 className='font-bold text-3xl md:text-5xl'>Lançamentos</h1>
                <span className='text-md md:text-lg'>Aproveite os produtos mais recentes!</span>
